...
``instanceof`` est utilisé pour déterminer si une variable PHP est un objet instancié d'une certaine classe, d'une classe
héritées, d'une interface ou s'il est de la même classe qu'un autre objet.
