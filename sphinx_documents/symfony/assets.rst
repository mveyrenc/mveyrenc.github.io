...
Télécharger `jQuery <http://jquery.com/download>`_ et placer le fichier ``jquery-2.1.3.min.js`` dans le répertoire ``public/js`` de notre bundle.
...
.. literalinclude:: code-block/assets/show.html.twig
    :language: html+jinja