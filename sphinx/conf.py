...
latex_documents = [
  (master_doc, 'Sphinx.tex', u'Sphinx',
...
man_pages = [
    (master_doc, 'sphinx', u'Sphinx Documentation',
     [author], 1)
]
...
extlinks = {
    ...
    'helios': ('https://helios.openwide.fr/ticket/%s', 'ticket ')
}

def setup(app):
    app.add_javascript("js/d3.min.js")
    app.add_javascript("js/nv.d3.min.js")
    app.add_stylesheet("css/nv.d3.min.css")