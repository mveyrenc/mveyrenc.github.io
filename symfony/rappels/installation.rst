.. _rappels-installation-configuration:

#############################
Installation et configuration
#############################

.. _rappels-installation:
...
#. Allez dans le centre de contrôle et ouvrez l'icône système (:menuselection:`Démarrer --> Paramètres --> Panneau de configuration --> Système`)
...
#. Entrez votre répertoire PHP à la fin, sans oublier cd commender par un point virgule (;), par exemple ``;C:\php``

#. Confirmez en cliquant sur OK

.. _rappels-configuration:
